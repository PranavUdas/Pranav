...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell = [cell initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:@"reuseCell"];
    
    cell.textLabel.text = @"Pranav Here";
    cell.detailTextLabel.text = @"At felix institute";
